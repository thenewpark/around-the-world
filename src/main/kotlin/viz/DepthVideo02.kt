            ...
            extend {
                video.draw {
                    ...
                    drawer.isolatedWithTarget(splitDepth) {
                        ...
                        drawer.image(it, Rectangle(splitImage.width.toDouble(), 0.0, splitImage.width.toDouble(), splitImage.height.toDouble()),
                    ...
                    drawer.isolatedWithTarget(splitImage) {
                        ...
                        drawer.image(it, Rectangle(0.0, 0.0, splitImage.width.toDouble(), splitImage.height.toDouble()),
                            Rectangle(0.0, 0.0, splitImage.width.toDouble(), splitImage.height.toDouble())
                        )
                    }
                    ...
                    checkers.apply(emptyArray(), arrayOf(image.colorBuffer(0)))
                    drawer.isolatedWithTarget(image) {
                        ...
                        drawer.shadeStyle = shadeStyle {
                            fragmentTransform = """
                                ...
                                float o = smoothstep(0.01, 0.0, abs(depth - splitDepth));
                                x_fill.a = o;
                            """.trimIndent()
